        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slide->subsubtitle }}</h2>
              <a href="{{ $slide->link }}"
              ...
              <div class="swiper-container js-swiper-slider" data-settings='{
                ...
                <div class="swiper-wrapper">
                    @foreach($sproducts as $sproduct)
                        @if($sproduct->sale_price < $sproduct->regular_price)
                            <div class="swiper-slide product-card product-card_style3">
                                ...
                                <div class="pc__info position-relative">
                                    <h6 class="pc__title">
                                        <a href="{{ route('shop.product.details', ['product_slug' => $sproduct->slug]) }}">{{ $sproduct->name }}</a>
                                    </h6>
                                    <div class="product-card__price d-flex">
                                        <span class="money price text-secondary">
                                            <s>&euro;{{ $sproduct->regular_price }}</s>
                                            &euro;{{ $sproduct->sale_price }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">
                    @if($fproduct->sale_price < $fproduct->regular_price)
                        <s>&euro;{{ $fproduct->regular_price }}</s>
                           &euro;{{ $fproduct->sale_price }}
                    @else
                        &euro;{{ $fproduct->regular_price }}
                    @endif
                  </span>
                </div>
              </div>
