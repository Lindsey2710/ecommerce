        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    <div class="text-tiny">Keep the product name simple.</div>
                </fieldset>
                @error('name')
                ...
                <fieldset class="shortdescription">
                    ...
                    <div class="text-tiny">Keep it short and clear.</div>
                </fieldset>
                ...
                <fieldset class="description">
                    ...
                    <div class="text-tiny">Give a clear description of the product.</div>
                </fieldset>
                @error('description')
                <span class="alert alert-danger text-center">
                    {{ $message }}
...
@push('scripts')
    <script>
        $(function() {
            ...
            // function for the gallery images
