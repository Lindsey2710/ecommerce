    ...
    <section class="shop-checkout container">
      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
          <table class="cart-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="shopping-cart__product-price">&euro;{{$item->price}}</span>
                </td>
                <td>
                ...
                <td>
                  <span class="shopping-cart__subtotal">&euro;{{$item->subTotal()}}</span>
                </td>
                <td>
                    {{-- remove by clicking x on item in shopping cart --}}
          ...
          {{-- Success or Error Message for coupons --}}
          <div>
        ...
        {{-- Cart info with and without coupon added --}}
            ...
            <div class="shopping-cart__totals">
              ...
              <table class="cart-totals">
                <tbody>
                        <tr>
                          <th>Subtotal</th>
                          <td>&euro;{{Cart::instance('cart')->subtotal()}}</td>
                        </tr>
                        <tr>
                            <th>Discount {{Session::get('coupon')['code']}}</th>
                            <td>&euro;{{Session::get('discounts')['discount']}}</td>
                        </tr>
                        <tr>
                            <th>Subtotal After Discount</th>
                            <td>&euro;{{Session::get('discounts')['subtotal']}}</td>
                          </tr>
                        <tr>
                          <th>Shipping</th>
                          <td>Free</td>
                        ...
                        <tr>
                          <th>BTW</th>
                          <td>&euro;{{Session::get('discounts')['tax']}}</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td>&euro;{{Session::get('discounts')['total']}}</td>
                        </tr>
                      </tbody>
                    </table>
              @else
              <table class="cart-totals">
                <tbody>
                        ...
                        <tr>
                          <th>BTW</th>
                          <td>&euro;{{Cart::instance('cart')->tax()}}</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td>&euro;{{Cart::instance('cart')->total()}}</td>
                        </tr>
                      </tbody>
                    </table>
                    @endif
