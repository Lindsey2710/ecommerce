                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('home.index') }}" id="site-logo-inner">
                            <img class="logo__image d-block" id="logo_header" alt="" src="{{ asset('images/logo/logo.png') }}"
                ...
                <div class="section-content-right">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{ asset('images/avatar/user-1.jpg')}}" alt="">
                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Admin Lindsey</span>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Linkatver. All rights reserved.</div>
                        </div>
                    </div>
